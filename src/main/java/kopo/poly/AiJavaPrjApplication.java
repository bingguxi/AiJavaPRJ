...
//
//        // 빈도수 결과를 정렬하기
//        // 정렬을 위해 맵에 저장된 레코드 1개(키, 값)를 리스트 구조로 변경하기
...
//        pDTO.setAddr("서울");
//
//        rList = studentService.insertStudent(pDTO); // 삽입 실행
//
//        rList.forEach(dto -> {
...
//        pDTO.setAddr("서울_수정");
//
//        rList = studentService.updateStudent(pDTO); // 수정 실행
//
//        rList.forEach(dto -> {
//            log.info("DB에 저장된 아이디 : " + dto.getUserId());
//            log.info("DB에 저장된 이름 : " + dto.getUserName());
...
//        studentService.deleteStudent(pDTO); // 삭제 실행
...
//        });
        ...
        student1.setUserId("bin23");
        student1.setUserName("박세빈");
        student1.setEmail("bin23@kopo.ac.kr");
        student1.setAddr("울산");

        StudentDTO student2 = new StudentDTO();
        student2.setUserId("young28");
        student2.setUserName("박세영");
        student2.setEmail("young28@kopo.ac.kr");
        student2.setAddr("제주도");

        StudentDTO student3 = new StudentDTO();
        student3.setUserId("sook22");
        student3.setUserName("손지숙");
        student3.setEmail("sook22@kopo.ac.kr");
        student3.setAddr("진주");
        ...
        List<StudentDTO> rList = studentService.saveStudents(pList); // 삽입 실행
